...
namespace Razorvine.Serpent.Test
{
	public class Testrunner
	{
		public static int Main(String[] args)
		{
		    ...
		    string loc= Assembly.GetAssembly(typeof(StringreaderTest)).Location;
		    ...
		    if( runner.Load(package) )
		    {
		        ...
		        TestResult results = runner.Run( new MyListener(), TestFilter.Empty, false, LoggingThreshold.Debug );
